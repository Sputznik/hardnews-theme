			...
			<div class="media">
				...
				<div class="media-body text-left">
					...
					<div class="post-date text-muted">
						...
						<?php echo do_shortcode('[rt_reading_time]'); ?> min read</div>
				</div>
			</div>
		...
		<ul>
			<li>			
				<div data-href="<?php echo get_permalink($post->ID); ?>" data-layout="button" data-size="small" data-mobile-iframe="true">
					<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink($post->ID)); ?>&t=>?php the_title_attribute();?>"><i class="fa fa-facebook fa-outline red-text-outline"></i></a>
				</div>
			</li>
			<li>
